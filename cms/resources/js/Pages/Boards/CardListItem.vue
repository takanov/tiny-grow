...
<template>
  <li class="relative p-2 bg-white border-b border-gray-300 rounded-md shadow group hover:bg-gray-50">
    <form
    ...
    <template v-if="!isShowingForm">
        ...
        <button
          ...
          class="absolute hidden w-8 h-8 m-1 text-gray-600 rounded-md top-1 right-1 bg-gray-50 group-hover:grid place-content-center hover:text-black hover:bg-gray-200">
